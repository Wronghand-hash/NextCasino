...
export const TopUpGameAccount: React.FC<TopUpGameAccountProps> = ({ program, fetchGameAccountBalance }) => {
  ...
  const topUpGameAccount = async () => {
    ...
    try {
      ...
      await fetchGameAccountBalance(); // Refresh game account balance after topping up
    } catch (err: any) {
      console.error(err);
